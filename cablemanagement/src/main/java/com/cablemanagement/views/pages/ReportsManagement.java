...
public class ReportsManagement {
    ...
    private static VBox createPurchaseReport() {
        ...
        // Sample data - in real app, fetch from View_Purchase_Report
        ObservableList<PurchaseReport> data = FXCollections.observableArrayList(
            new PurchaseReport("INV-RP-001", "2025-07-01", "RawMetals Pvt Ltd", "25000.00", "1000.00", "20000.00"),
            new PurchaseReport("INV-RP-002", "2025-07-03", "Insulation Depot", "10000.00", "0.00", "10000.00")
        );
        table.setItems(data);
    ...
    private static VBox createReturnPurchaseReport() {
        ...
        // Sample data - in real app, fetch from View_Return_Purchase_Report
        ObservableList<ReturnPurchaseReport> data = FXCollections.observableArrayList(
            new ReturnPurchaseReport("INV-RPR-001", "2025-07-04", "RawMetals Pvt Ltd", "5000.00", "0.00", "5000.00")
        );
        table.setItems(data);
    ...
    private static VBox createBankTransferReport() {
        ...
        // Sample data - in real app, fetch from View_Bank_Transfer_Report
        ObservableList<BankTransferReport> data = FXCollections.observableArrayList(
            new BankTransferReport("2025-07-04", "HBL", "MCB", "50000.00")
        );
        table.setItems(data);
